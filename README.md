...
> **권장 환경:** 데스크톱 Chrome 브라우저, 가로 1280px 이상. 본 서비스는 PC 환경 전용으로 설계했다.
...
1. **👑 높은 자유도의 스쿼드 & 포메이션 샌드박스 (Squad Sandbox)**
   * 4-3-3, 3-5-2 등 4종 포메이션 실시간 전환 및 마우스 드래그 앤 드롭 / 클릭 맞교환(Click-to-Swap)으로 구장 11명·벤치 9명(총 20인)을 자유롭게 교체한다.
...
| 폰트 / 아이콘 | 시스템 폰트 + 유니코드 이모지 | 별도 웹폰트·아이콘 패키지 미사용 |
