...
2026 북중미 월드컵 본선에서 대한민국은 조별리그 남아공전 0-1 패배로 조 3위에 그쳤습니다. 국내 언론과 축구 커뮤니티가 반복해서 지적한 전술적 쟁점은 세 가지입니다.

1. **U자형 빌드업:** 공격 전개가 센터백과 풀백 사이 횡패스에 갇히는 문제는 홍명보 감독 본인이 부임 워크숍에서 먼저 꺼낸 주제였습니다. "상대를 몰아놓고 공격하게 되면 우리가 U자형 플레이를 하게 된다"며 약팀에 역습으로 지는 원인으로 짚었지만, 부임 첫 경기 팔레스타인전(0-0)에서 매체는 "U자 빌드업의 형태가 자주 나왔다"고 적었습니다 ([Interfootball, 2024](https://sports.news.nate.com/view/20240905n41102)). 2년 뒤 본선에서도 직전 10경기 중 9경기가 같은 스리백이었고, 남아공전에서는 뒤진 상황에서도 공격 전환에 실패했습니다 ([MBC, 2026a](https://imnews.imbc.com/replay/2026/nwdesk/article/6833724_37004.html)). 감독 스스로 "왜 이런 경기력이 나왔는지 당황스럽다"며 원인을 특정하지 못했습니다 ([Hankook Ilbo, 2026](https://www.hankookilbo.com/news/article/A2026062608010004313)).
2. **스리백 측면의 뒷공간:** 윙백이 공격에 가담한 뒤 열리는 뒷공간이 반복 공략됐습니다. 브라질전과 코트디부아르전 모두 수비가 흔들렸고, 남아공전에서는 슈팅 8대 13으로 밀리다 후반 18분 마세코에게 결승골을 내줬습니다 ([Financial News, 2026a](https://www.fnnews.com/news/202606251312188929)).
3. **스타 개인 기량 의존:** 플랜 B 없이 손흥민 등 스타의 기량에 기대는 운영을 두고 팬들 사이에서 '해줘 축구'라는 말이 나왔습니다. 탈락 기로의 최종전에서 손흥민을 벤치에 앉히는 변칙 승부수를 던졌지만 ([Financial News, 2026b](https://www.fnnews.com/news/202606251055226408)), 후반 교체 카드는 듣지 않았고 선발 원톱 오현규는 고립됐습니다 ([Korea Daily, 2026](https://www.koreadaily.com/article/20260625003112534); [MBC, 2026b](https://imnews.imbc.com/news/2026/sports/article/6832790_36946.html); [Kyeonggi Ilbo, 2026](https://www.kyeonggi.com/article/20260626580030)).

이 쟁점에 대해 대중이 할 수 있는 일은 관전과 텍스트 비평뿐이었습니다. 반대편의 Football Manager는 시즌 운영 도구라 '그 경기의 그 장면'만 다시 지휘하려는 사람과는 목적이 다릅니다. 본 서비스는 선택지를 **4대 전술 다이얼 × 3안과 특수 지침 토글 2종** 으로 한정하고, 저장 파일도 시즌 진행도 없이 단 한 경기만 다룹니다. 대신 모든 선택이 바꾸는 즉시 팀 지표와 여론 수치로 되돌아옵니다. 학습 곡선이 있어야 할 자리를 **즉각적인 인과 피드백** 으로 대체한 것이 본 서비스의 접근입니다.

### 1.2 서비스 정의

**K-Tactics Lab 2026** 은 2026 월드컵 조별리그 남아공전(0-1 패)을 사용자가 직접 다시 지휘하는 **한 경기 전술 지휘 시뮬레이터**입니다. 시즌도 저장도 없이 그 한 경기만 다룹니다. 수석 감독석에 앉아 언론이 지적한 3대 쟁점을 자신의 방식으로 격파하는 것이 목표이며, 진입 시 남아공전 재지휘 대신 **자유 모드**를 골라 멕시코·스페인을 상대로 같은 판을 시험할 수도 있습니다. 포메이션과 2026 월드컵 공식 출전 20인(구장 11명 + 벤치 9명)을 자유롭게 배치하고, 4대 전술 다이얼과 감독 특수 지침으로 국면마다 결단합니다. 모든 선택은 팀 밸런스 수치와 대중 여론 지지도(Vibe Meter)로 즉시 되돌아오며, 경기 결과와 여론은 끝까지 별개의 성적표로 남습니다.

### 1.3 서비스의 독창성 및 차별점

축구 시뮬레이션도, 전술 투표나 팬 설문도 이미 많습니다. 본 서비스가 그것들과 갈라지는 지점은 세 가지이며, 모두 화면에서 곧바로 확인되는 형태로 구현했습니다.

1. **상대가 이쪽을 스카우팅하는 적대적 루프 (Manager vs AI Manager):** 대개의 전술 시뮬레이터에서 상대는 고정된 난이도 값입니다. 본 서비스의 **AI 상대 감독** 은 킥오프마다 사용자의 XI와 다이얼을 읽고 카운터 전술을 구조화 JSON으로 결정한 뒤, 실제 확률 연산(5.3의 $f_{	ext{상대감독}}$ 배수)에 반영합니다. 내 판을 바꾸면 상대의 대응도 바뀌므로, 마주하는 것은 난이도 슬라이더가 아니라 **판단하는 상대 감독** 입니다. 수석 코치 **Coach V** 도 같은 레이어 위에 있고, 네트워크나 무료 한도 실패 시 스크립트 폴백으로 무중단 동작합니다.
...
감독을 평가하는 것은 승패만이 아닙니다. 본 서비스는 **"전술적 선택과 스쿼드 배치가 팀 밸런스와 대중 여론에 어떤 상충을 만드는가"** 를 감독석에서 겪게 하는 것을 목표로 합니다.
...
3. **국면 ③: 후반 플랜 B 및 위기관리**
   - **설계 의도:** 전반이 끝나면 선수 카드의 체력 게이지가 일제히 갱신되고, **[⏱️ 60분 조커 투입]** 과 **[⏱️ 75분 닥공 전환]** 예약 버튼이 나타납니다. 방전된 선수를 눈으로 확인한 뒤 승부수를 설계하는 구간입니다. 60분 교체를 예약하면 가장 방전된 선수가 벤치의 프레시 레그로 실제 교체되고, 올라간 평균 체력이 몬테카를로의 체력 계수에 그대로 반영됩니다. 표기된 분(分)은 중계 연출이고, 후반을 분 단위로 쪼개지 않은 것은 하프타임의 결단 하나에 무게를 싣기 위해서입니다. 교체는 3대 국면 중 여기서만 열립니다.

---

## 3. 페이지 구성 및 UI 레이아웃 (Page Structure)

전술 설정·피드백·시뮬레이션을 한 화면에 모은 **'매치데이 브로드캐스트 보드'** 단일 레이아웃입니다. 중계 화면의 문법(스코어버그, 선수 카드)을 빌려 **경기장을 화면의 주인공**으로 두고, 보조 정보는 우측 3탭 레일과 접이식 칩으로 밀어냈습니다. 상단 탭으로 [전술 보드]와 [락커룸] 뷰를 전환합니다.
...
1. **슬림 브로드캐스트 헤더:** [전술 보드]/[락커룸] 전환 탭, **KOR 대 상대국 스코어버그**, 팬 지지율 바, 사운드 토글, 그리고 국면에 따라 라벨이 바뀌는 CTA **[▶ 경기 시뮬레이션] → [🔥 후반전 승부수 가동] → [🔄 다시 처음부터]** 를 한 줄에 담았습니다. 스코어버그는 `0:0 SET-UP → 1H LIVE → HALF-TIME 45' → 2H LIVE → FULL-TIME 90'` 로 진행을 따라갑니다.
2. **중앙 매치데이 스테이지 (Center Stage):**
   - **매치 컨트롤 스트립:** 포메이션(4-3-3, 3-5-2, 4-2-3-1, 4-4-2) 즉시 전환과 상대국 3개국(멕시코/스페인/남아공) 선택. 실제 남아공전은 스리백(3-4-3)이었으므로(FBref 경기 기록), 3-5-2로 그날의 대형을 재현하거나 포백으로 옮겨 구조 자체를 갈아엎는 선택이 모두 가능합니다.
   - **스타디움 캠 피치:** 선발 11인의 **선수 카드**(FBref 레이팅, 포지션 컬러, 체력 게이지)가 포메이션 대형 그대로 놓이고, 드래그와 클릭 양쪽으로 교체됩니다.
   - **AI 상대 감독 접이식 칩:** 스카우팅 브리핑과 경기 진행 상태를 중계하고, 하프타임에는 교체 예약 버튼을 담습니다.
   - **팀 밸런스 HUD:** 공격·수비·중원·체력 4대 속성을 피치 바로 아래 막대 4개로 상시 노출합니다 (FBref 기반 0~100).
   - **상시 전술 덱:** 4대 다이얼과 **감독 특수 지침 토글 2종**(U자 백패스 금지, 이강인 프리롤)을 탭 뒤에 숨기지 않고 가로 덱으로 노출했습니다. 전술을 바꾼 손이 그대로 HUD와 지지율이 움직이는 것을 보게 하려는 배치입니다.
...
- **지금 어떤 방식으로 조작 중인지 화면에 남습니다.** 드래그로 잡은 카드는 반투명해지고, 클릭으로 고른 카드는 반대로 확대되며, 놓을 수 있는 슬롯은 앰버빛 테두리로 표시됩니다.

### 4.2 인터랙션 B: 비정상 배치 감지 및 AI 코치 경고

- **판정:** 배치된 선수의 포지션 속성과 슬롯을 비교합니다. 공격 자원이 최후방·골문에 놓이거나 골키퍼가 최전방에 놓이면 걸립니다.
- **반응:** AI 코치 긴급 경보가 뜨고 여론 지지율에 **−25(공격 자원을 최후방·골문에) ~ −30(골키퍼를 최전방에)** 이 즉시 반영됩니다. 40% 미만으로 떨어지면 붉은 경고 상태로 전환되고 중계창에 비판 댓글이 올라옵니다.
...
표에 담기지 않는 설계 의도가 셋 있습니다.

- **하프타임은 정보를 받는 자리입니다.** 전반이 끝나면 Coach V가 두 우위 지수를 **실제 수치로** 보고합니다. 무엇이 기준선에 모자랐는지 보고 후반을 고치라는 구간이지, 그냥 넘어가는 화면이 아닙니다. 킥오프 시점에 **AI 상대 감독** 이 우리 XI를 스카우팅해 카운터를 정한 것도 이때 통보됩니다.
- **키커 명단은 전술판이 정합니다.** PK 후보는 **가장 전방에 놓인 7개 슬롯** 이라, 누구를 앞세울지 정한 배치가 그대로 키커 풀이 됩니다. 이 중 5인의 순서만 직접 지정합니다.
- **칭호는 어긋난 채로 남습니다.** **이기고도 지지율이 40 미만이면 "이기고도 경질설 — 여론을 잃은 승장", 지고도 70 이상이면 "졌지만 방향은 옳았다 — 지지받는 패장"** 이 됩니다. **[명함 카드 저장]** 은 2배 해상도 PNG, **[공유하기]** 는 현재 전술을 URL로 인코딩한 **"이 전술 이겨봐" 도전 링크** 를 함께 보내고, **[🔄 다시 처음부터]** 는 체력과 스카우팅만 초기화하고 전술 세팅은 유지합니다.
...
**전반 45분은 확률이 아니라 준비의 결과입니다.** 유저가 되돌리고 싶은 것은 "그날의 0:1"이라는 특정 상황인데, 전반부터 표집하면 되돌릴 상황이 매번 달라져 서사가 성립하지 않습니다. 그래서 같은 보드면 전반 스코어도 같습니다. 대신 확정이되 **계산된** 값으로, 양쪽의 우위 지수가 기준선을 넘는지 봅니다.
...
이 구조가 뜻하는 것은 **전술 지침만으로는 부족하고 그것을 감당할 스쿼드가 있어야 한다**는 겁니다. 개막 보드는 공격 70 대 남아공 수비 70이라 우위가 정확히 1.00이고, 하프스페이스 침투의 +0.10을 켜야 기준선 1.10에 닿습니다. **언론이 요구한 개혁이 여전히 정공법**입니다. 반대로 손흥민을 벤치에 앉히거나 상대를 스페인으로 바꾸면 같은 지침으로도 기준선을 넘지 못합니다. 하프타임 브리핑이 두 지수를 실제 수치로 보여주므로, 무엇이 모자랐는지 보고 후반에 고칠 수 있습니다.
...
- **1,000회인 이유:** 표집 오차가 화면에 찍히는 정수 퍼센트 한 칸 수준(보드에 따라 ±0.9~1.3%p)으로 내려오는 지점이고, 10,000회로 늘려도 정수로 반올림하면 차이가 대부분 사라집니다. 표집기에 편향이 없다는 것은 해석적으로 계산한 승률 **8.90%** 와 20만 회 표집값 **8.88%** 를 대조해 확인했습니다.
...
| 다이렉트 템포 | +5 | 지공 빌드업 | −4 |
| 4-3-3 | +5 | 이강인 프리롤 | −3 |
| 하프스페이스 침투 | +3 | 비정상 포지션 배치 | −25~−30 |

개혁 성향의 지침이 왼쪽에, 수비적 선택이 오른쪽에 모입니다. 다만 오른쪽 두 항목은 성격이 다릅니다. **손흥민 벤치 −18은 실제 남아공전 논란에서 가져온 값이고, 비정상 포지션 배치 −25~−30은 전술이 아니라 배치 오류에 붙는 페널티**입니다.
...
▲ 왼쪽이 감독이 하는 것, 오른쪽이 **그 자리에서 돌아오는 것**입니다. 이 서비스에는 저장도 시즌도 없고, 대신 모든 선택이 즉시 팀 지표·여론·λ로 되돌아옵니다. 오른쪽 열이 비어 있는 단계가 하나도 없다는 것이 §1.3에서 말한 "학습 곡선 대신 즉각적 인과"의 실제 모습입니다. 초록 점선은 재도전 루프로, XAI가 짚어준 패인을 들고 **같은 보드**로 다시 들어가는 경로입니다.

- **국면 ③은 경기 중에 옵니다.** 단계 2의 다이얼이 킥오프 전 결단이라면, 60분 조커 투입과 75분 닥공 전환은 하프타임에 스코어와 체력을 보고 나서 예약합니다. 같은 다이얼이라도 언제 돌리느냐가 다른 결정입니다.
- **같은 전술도 상대가 바뀌면 평가가 뒤집힙니다.** 스페인 상대 U자 백패스 금지는 여론 +6이지만, 멕시코 상대 게겐프레싱은 −10입니다(§5.5).
