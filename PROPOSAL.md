...
2. **중앙 매치데이 스테이지 (Center Stage):**
   - **매치 컨트롤 바:** 포메이션(4-3-3, 3-5-2, 4-2-3-1, 4-4-2) 즉시 전환과 상대국 선택. 3개국은 실제 2026 본선 조별리그에서 만난 **체코(2-1 승)·멕시코(0-1 패)·남아공(0-1 패)** 그대로입니다. 남아공전은 스리백(3-4-3)이었으므로(FBref 경기 기록), 3-5-2로 그날의 대형을 재현하거나 포백으로 옮겨 구조 자체를 갈아엎는 선택이 모두 가능합니다.
