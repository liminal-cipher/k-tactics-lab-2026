...
전술 설정·피드백·시뮬레이션을 한 화면에 모은 **'매치데이 브로드캐스트 보드'** 단일 레이아웃입니다. 중계 화면의 문법(스코어버그, 선수 카드)을 빌려 **경기장을 화면의 주인공**으로 두고, 보조 정보는 우측 3탭 레일과 접이식 칩으로 밀어냈습니다.

![매치데이 브로드캐스트 보드 실제 구현 화면](docs/img/proposal-board.png)

▲ 실제 구현 화면. 번호는 아래 3.1의 여섯 영역에 대응합니다: **① 슬림 브로드캐스트 헤더 ② 매치 컨트롤 스트립 ③ AI 상대 감독 접이식 칩 ④ 팀 밸런스 HUD ⑤ 상시 전술 덱 ⑥ 우측 3탭 레일**
