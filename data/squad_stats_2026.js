...
const SQUAD_STATS_2026 = {
  ...
  '손흥민': {
    ...
    rating: 92, statStr: 'FBref 공인: 3경기(169분) 출전 / Sh/90 3.73',
    attack: 83, defense: 38, midfield: 62, stamina: 82,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 95, composure: 94
  },
  '이강인': {
    pos: 'FW/MF', age: '25-144', mp: 3, starts: 3, min: 270, gls: 0, ast: 1,
    rating: 90, statStr: 'FBref 공인: 3경기(270분 풀타임) 1도움 / Crs 19',
    attack: 75, defense: 43, midfield: 86, stamina: 87,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 88, composure: 92
  },
  '오현규': {
    pos: 'FW', age: '25-092', mp: 3, starts: 1, min: 129, gls: 1, ast: 0,
    rating: 84, statStr: 'FBref 공인: 3경기(129분) 1골 / Sh/90 2.79',
    attack: 86, defense: 36, midfield: 58, stamina: 86,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 87, composure: 83
  },
  '황희찬': {
    pos: 'FW', age: '30-168', mp: 3, starts: 1, min: 108, gls: 0, ast: 0,
    rating: 85, statStr: 'FBref 공인: 3경기(108분) 출전 / Sh/90 0.83',
    attack: 73, defense: 39, midfield: 55, stamina: 84,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 85, composure: 84
  },
  '조규성': {
    pos: 'FW', age: '28-169', mp: 2, starts: 0, min: 31, gls: 0, ast: 0,
    rating: 83, statStr: 'FBref 공인: 2경기(31분) 출전 (소표본)',
    attack: 74, defense: 36, midfield: 53, stamina: 85,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 86, composure: 85
  },
  '양현준': {
    pos: 'FW/MF', age: '24-049', mp: 1, starts: 0, min: 20, gls: 0, ast: 0,
    rating: 80, statStr: 'FBref 공인: 1경기(20분) 출전 (소표본)',
    attack: 69, defense: 45, midfield: 65, stamina: 87,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 79, composure: 78
  },
  '엄지성': {
    pos: 'MF/FW', age: '24-065', mp: 2, starts: 0, min: 42, gls: 0, ast: 0,
    rating: 80, statStr: 'FBref 공인: 2경기(42분) 출전 / TklW 2',
    attack: 67, defense: 46, midfield: 69, stamina: 87,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 80, composure: 79
  },
  '이재성': {
    pos: 'FW/MF', age: '33-337', mp: 2, starts: 2, min: 117, gls: 0, ast: 0,
    rating: 86, statStr: 'FBref 공인: 2경기(117분) 선발 / TklW 3, Fld 4',
    attack: 72, defense: 57, midfield: 69, stamina: 83,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 81, composure: 88
  },
  // --- Midfielders (MF) ---
  '황인범': {
    pos: 'MF', age: '29-296', mp: 3, starts: 3, min: 263, gls: 1, ast: 1,
    rating: 89, statStr: 'FBref 공인: 3경기(263분) 1골 1도움 / Int/90 1.38',
    attack: 71, defense: 63, midfield: 82, stamina: 88,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 84, composure: 90
  },
  '백승호': {
    pos: 'MF', age: '29-118', mp: 3, starts: 3, min: 204, gls: 0, ast: 0,
    rating: 84, statStr: 'FBref 공인: 3경기(204분) 선발 / 슈팅 0회',
    attack: 57, defense: 55, midfield: 76, stamina: 88,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 80, composure: 85
  },
  '김진규': {
    pos: 'MF', age: '29-139', mp: 2, starts: 0, min: 52, gls: 0, ast: 0,
    rating: 81, statStr: 'FBref 공인: 2경기(52분) 출전 / Sh/90 1.73',
    attack: 58, defense: 56, midfield: 76, stamina: 88,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 77, composure: 82
  },
  '옌스 카스트로프': {
    pos: 'MF', age: '22-349', mp: 1, starts: 0, min: 45, gls: 0, ast: 0,
    rating: 81, statStr: 'FBref 공인: 1경기(45분) 출전 / Crs 3',
    attack: 57, defense: 52, midfield: 76, stamina: 90,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 75, composure: 81
  },
  '설영우': {
    pos: 'MF/DF', age: '27-220', mp: 3, starts: 3, min: 250, gls: 0, ast: 0,
    rating: 85, statStr: 'FBref 공인: 3경기(250분) 선발 / Crs 9',
    attack: 60, defense: 67, midfield: 77, stamina: 88,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 72, composure: 84
  },
  '이태석': {
    pos: 'MF/DF', age: '23-350', mp: 2, starts: 2, min: 113, gls: 0, ast: 0,
    rating: 81, statStr: 'FBref 공인: 2경기(113분) 선발 / TklW 3, Crs 8',
    attack: 58, defense: 72, midfield: 74, stamina: 89,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 70, composure: 80
  },
  '김문환': {
    pos: 'MF/DF', age: '30-346', mp: 1, starts: 1, min: 70, gls: 0, ast: 0,
    rating: 81, statStr: 'FBref 공인: 1경기(70분) 출전 / Int 1, TklW 1',
    attack: 58, defense: 71, midfield: 65, stamina: 86,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 71, composure: 82
  },
  // --- Defenders (DF) ---
  '김민재': {
    pos: 'DF', age: '29-240', mp: 3, starts: 3, min: 245, gls: 0, ast: 0,
    rating: 91, statStr: 'FBref 공인: 3경기(245분) 선발 / Int 2, TklW 2 [수동 보정]',
    attack: 42, defense: 90, midfield: 51, stamina: 87,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 65, composure: 89
  },
  '이한범': {
    pos: 'DF', age: '24-026', mp: 3, starts: 3, min: 270, gls: 0, ast: 0,
    rating: 83, statStr: 'FBref 공인: 3경기(270분 풀타임) / Int 3, TklW 2',
    attack: 42, defense: 81, midfield: 54, stamina: 88,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 58, composure: 82
  },
  '이기혁': {
    pos: 'DF', age: '26-006', mp: 3, starts: 3, min: 270, gls: 0, ast: 0,
    rating: 83, statStr: 'FBref 공인: 3경기(270분 풀타임) / Int 5, TklW 4 (팀내 최고)',
    attack: 40, defense: 88, midfield: 53, stamina: 88,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 55, composure: 81
  },
  '박진섭': {
    pos: 'DF/MF', age: '30-263', mp: 2, starts: 0, min: 32, gls: 0, ast: 0,
    rating: 82, statStr: 'FBref 공인: 2경기(32분) 출전 / SoT 1 (소표본)',
    attack: 53, defense: 66, midfield: 63, stamina: 86,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 62, composure: 83
  },
  // --- Goalkeepers (GK) ---
  '김승규': {
    pos: 'GK', age: '35-286', mp: 3, starts: 3, min: 270, gls: 0, ast: 0,
    rating: 89, statStr: 'FBref 공인: 3경기(270분 풀타임) / GA 3, Save% 75.0%',
    attack: 30, defense: 84, midfield: 40, stamina: 80,
    npxG: '─', progPasses: '─', aerialWon: '─', shooting: 30, composure: 91
  },
};
